<div align="center">
  ...
  <p><strong>2.9.4-rc.1 release candidate</strong> · <a href="README.md">中文</a> · <a href="docs/CURRENT_STATE.md">Current verification</a> · <a href="docs/DEPLOYMENT.md">Deployment and rollback</a></p>
</div>
...
| Human acceptance | The Human Acceptance Center explains the 300 gold cases and 60 sealed holdouts, then provides source, accept, correct, and seal actions | Machine candidates never count automatically; a sealed case requires a second reviewer |
...
The current 2.9.4-rc.1 gate reports

- 149 passing Python tests and 1 environment-dependent skip for the Windows DPAPI protected path
...
- 11 passing Chromium flows, with 3 conditional flows requiring local extended fixtures not enabled in this run
...
These numbers describe fixed samples only and do not imply 95% accuracy for arbitrary novels. The database currently contains 28 machine-prepared candidates, 0 provably human-confirmed cases, and 0 valid sealed holdouts. A reviewer can open Quality Check, Gold Standard, and Human Acceptance Center to inspect the source and accept or correct each candidate
