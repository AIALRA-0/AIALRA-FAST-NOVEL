...
The guided 3D atlas reuses the same X/Y coordinates. Z represents evidenced containment depth only, never altitude. The active route, region, and chronology step remain synchronized
