<div align="center">
  ...
  <p><strong>2.9.4-rc.1 候选版</strong> · <a href="README.en.md">English</a> · <a href="docs/CURRENT_STATE.md">当前验证状态</a> · <a href="docs/DEPLOYMENT.md">部署与回滚</a></p>
</div>

这是一个可本地运行的个人项目，不是已经承诺服务等级的多租户平台；人工质量集尚未完成，项目不会提前宣称达到 95% 通用小说准确率
...
| 人工验收 | “人工验收中心”解释 300 条金标准和 60 条密封题的作用，并提供逐题原文、接受、修正和密封入口 | 机器候选不会自动计入人工成绩；密封题还需第二位审核者复核 |
...
这些数字只证明固定样本，不表示任意小说天然达到95%准确率；当前有28条机器准备的候选案例，可证明的人工确认案例为0，有效密封保留案例为0；用户可以在“质量检查 → 金标准 → 人工验收中心”逐题打开原文并接受或修正答案

正式质量集采用 12 部开放作品，每部 25 条，其中 20 条开发案例和 5 条密封保留案例
